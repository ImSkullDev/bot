...
class Database extends EventEmitter {
	constructor(parent) {
		...
		this.serverListClient = new MongoDB.MongoClient(process.env.MONGO_SERVERS, { useNewUrlParser: true, useUnifiedTopology: true });
		this.db = null;
	...
	connect() {
		return this.client.connect()
			.then(() => this.serverListClient.connect())
			.then(() => {
				this.ready = true;
				...
				this.serverDB = this.serverListClient.db('serverlist');
			});
	}
